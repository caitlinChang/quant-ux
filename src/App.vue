  ...
  methods: {
    showSuccess(msg) {
      if (this.$refs.message) {
        ...
        css.remove(
          this.$refs.message,
          "vommondMessageError vommondMessageHint"
        );
    ...
    showError(msg) {
      if (this.message) {
        ...
        css.remove(
          this.$refs.message,
          "vommondMessageSuccess vommondMessageHint"
        );
        this.$refs.message.innerHTML = msg;
        setTimeout(() => {
          this.hideMessage();
    ...
    showHint(msg) {
      if (this.$refs.message) {
        ...
        css.remove(
          this.$refs.message,
          "vommondMessageSuccess vommondMessageSuccess"
        );
        this.$refs.message.innerHTML = msg;
        setTimeout(() => {
          this.hideMessage();
    ...
    hideMessage() {
      css.remove(
        this.$refs.message,
        "vommondMessageSuccess vommondMessageError vommondMessageHint"
      );
    },
