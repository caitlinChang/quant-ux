<template>
  <div class="MatcToolbar" @dblclick="onDoubleClick">
    <div class="" data-dojo-attach-point="layerListCntr"></div>

    <div class="MatcToobarLeft" data-dojo-attach-point="toolsSection">
      <div class="hidden" data-dojo-attach-point="importSection"></div>

      <div
        class="MatcToolbarItem MatcToolbarItemActive"
        data-dojo-attach-point="editTool"
      >
      ...
      <div
        class="MatcToolbarItem MatcMultiIcon"
        data-dojo-attach-point="rectangleTool"
      >
        <span class="mdi mdi-square-outline"></span>
        <span
          class="mdi mdi-plus-circle MatcTinyIcon MatcTinyIconAnimated"
        ></span>
      </div>

      <div
        class="MatcToolbarItem MatcMultiIcon"
        data-dojo-attach-point="textTool"
      >
      ...
      <div
        class="MatcToolbarItem MatcMultiIcon"
        data-dojo-attach-point="hotspotTool"
      >
      ...
      <div
        class="MatcToolbarItem MatcMultiIcon"
        data-dojo-attach-point="addLogicSection"
      >
      ...
      <div
        class="MatcToolbarItem MatcMultiIcon"
        data-dojo-attach-point="addRestSection"
        v-show="showRestTool"
      >
      ...
      <div
        class="MatcToolbarItem MatcMultiIcon"
        data-dojo-attach-point="addScriptSection"
      >
      ...
      <div
        class="MatcToolbarItem MatcToolbarMove"
        data-dojo-attach-point="moveTool"
      >
      ...
      <div
        class="MatcToolbarItem MatcMultiIcon"
        data-dojo-attach-point="selectBtn"
      >
      ...
      <div class="" data-dojo-attach-point="commentSection">
        <div
          class="MatcToolbarItem MatcMultiIcon"
          data-dojo-attach-point="commentBtn"
        >
      ...
      <div
        class="MatcToolbarItem MatcToolbarItemChat MatcMultiIcon"
        data-dojo-attach-point="addGPTSection"
        @click.stop="showDesignGPT"
        v-show="hasProtoMoto"
      >
    ...
    <div class="MatcToolbarTop">
      <div
        class="MatcToobarHomeSection MatcToobarItemBig"
        data-dojo-attach-point="home"
      ></div>

      <div class="MatcToolbarTopCntr">
        <div
          class="MatcToobarSimulatorSection MatcToolbarSection"
          data-dojo-attach-point="simulatorSection"
        >
          <a
            class="MatcToolbarItem MatcToolbarIconNoSmooth"
            data-dojo-attach-point="simulatorButton"
          >
            <span
              class="mdi mdi-play"
              style="vertical-align: middle"
              data-dojo-attach-point="simulatorIcon"
            ></span>
            <span class="MatcToolbarLabel MatcToolbarResponsiveLabel">{{
              $t("toolbar.simulate")
            }}</span>
          </a>
        </div>
        ...
        <div
          class="MatcToolbarSection MatcToolbarDenseSection"
          v-show="svgEditorVisible"
        >
          <a
            class="MatcToolbarItem MatcToolbarIconNoSmooth MatcToolbarItemDisbaled"
            ref="svgUndo"
            @click="onSVGUndo"
          >
        ...
        <div
          v-show="svgEditorVisible"
          class="MatcToolbarSection MatcToolbarMaxSection"
        >
          <div class="MatcToolbarItem">
            <div
              class="MatcButton MatcToolbarCloseButton"
              @click="onToolSVGEnd"
            >
              {{ $t("toolbar.svgStop") }}
            </div>
        ...
        <div
          class="MatcToolbarSection MatcToolbarDenseSection"
          data-dojo-attach-point="undoSection"
          v-show="!svgEditorVisible"
        >
          <a
            class="MatcToolbarItem MatcToolbarIconNoSmooth MatcToolbarItemDisbaled"
            data-dojo-attach-point="undo"
          >
            <span class="mdi mdi-undo"></span>
          </a>
          <a
            class="MatcToolbarItem MatcToolbarIconNoSmooth MatcToolbarItemDisbaled"
            data-dojo-attach-point="redo"
          >
            <span class="mdi mdi-redo"></span>
          </a>
        </div>
        ...
        <div
          class="MatcToolbarSection MatcToolbarDenseSection"
          data-dojo-attach-point="copyPasteDiv"
          v-show="!svgEditorVisible"
        >
          <a
            class="MatcToolbarItem MatcToolbarItemDisbaled"
            data-dojo-attach-point="copyBtn"
          >
            <span class="mdi mdi-content-copy"></span>
          </a>
          <a
            class="MatcToolbarItem MatcToolbarItemDisbaled"
            data-dojo-attach-point="pasteBtn"
          >
            <span class="mdi mdi-content-paste"></span>
          </a>
          <a
            class="MatcToolbarItem MatcToolbarItemDisbaled"
            data-dojo-attach-point="copyStyleBtn"
          >
            <span class="mdi mdi-format-paint"></span>
          </a>
          <a
            class="MatcToolbarItem MatcToolbarItemDisbaled"
            data-dojo-attach-point="deleteBtn"
          >
        ...
        <div class="MatcToolbarTopCenterCntr" v-show="!svgEditorVisible">
          <div
            class="MatcToolbarSection MatcToolbarDenseSection MatcToolbarSectionTools MatcToolbarSectionHidden"
            data-dojo-attach-point="toolsCntrDiv"
          >
            <div
              class="MatcToolbarSubSection"
              data-dojo-attach-point="groupDIV"
            >
              <a
                class="MatcToolbarItem MatcMultiIcon"
                data-dojo-attach-point="groupBTN"
              >
                <span class="mdi mdi-vector-union"></span>
                <span class="mdi mdi-plus-circle MatcTinyIcon"></span>
              </a>
              <a
                class="MatcToolbarItem MatcMultiIcon MatcIconDanger"
                data-dojo-attach-point="ungroupBTN"
              >
                <span class="mdi mdi-vector-union"></span>
            ...
            <div
              class="MatcToolbarSubSection"
              data-dojo-attach-point="templateDiv"
            ></div>

            <div
              class="MatcToolbarSubSection"
              data-dojo-attach-point="magicCopyDiv"
            ></div>

            <div
              class="MatcToolbarSubSection"
              data-dojo-attach-point="toolsDiv"
            ></div>

            <div
              class="MatcToolbarSubSection"
              data-dojo-attach-point="developerDiv"
            ></div>
          </div>
        </div>

        <div
          class="MatcToolbarNotificationSection MatcToolbarSection"
          data-dojo-attach-point="notificationSection"
        >
          ...
          <ViewConfig
            :value="canvasViewConfig"
            @change="onChangeCanvasViewConfig"
            v-if="hasViewConfigVtn"
          />
          <HelpButton :hasNotifications="true" :hasToolbar="true" />
        </div>

        <div
          class="MatcToobarSignUpSection MatcToolbarSection MatcToolbarSectionHidden"
          data-dojo-attach-point="signupSection"
        >
          <a
            class="MatcToolbarItem MatcToolbarIconNoSmooth"
...
export default {
  ...
  methods: {
    postCreate() {
      ...
      this.own(
        on(this.copyStyleBtn, touch.press, lang.hitch(this, "onToolCopyStyle"))
      );
      this.own(
        on(this.commentBtn, touch.press, lang.hitch(this, "onNewComment"))
      );
      ...
      this.own(
        on(
          this.signupSection,
          touch.press,
          lang.hitch(this, "showSignUpDialog")
        )
      );
      ...
      this.own(
        on(
          this.selectBtn,
          touch.press,
          lang.hitch(this, "onToolSelect", "select")
        )
      );
      this.own(on(this.groupBTN, touch.press, lang.hitch(this, "onToolGroup")));
      this.own(
        on(this.ungroupBTN, touch.press, lang.hitch(this, "onToolGroup"))
      );
      this.own(
        on(this.hotspotTool, touch.press, lang.hitch(this, "onToolHotspot"))
      );
    ...
    getMainMenu() {
      var options = [
        {
          label: this.getNLS("toolbar.menu.start"),
          callback: lang.hitch(this, "startSimilator"),
        },
        {
          label: this.getNLS("toolbar.menu.settings"),
          callback: lang.hitch(this, "onShowSettings"),
        },
        {
          label: this.getNLS("toolbar.menu.shortcuts"),
          callback: lang.hitch(this, "showShortCuts"),
        },
        {
          label: this.getNLS("toolbar.menu.share"),
          callback: lang.hitch(this, "showSharing"),
        },
        {
          label: this.getNLS("toolbar.menu.import"),
          callback: lang.hitch(this, "showImportDialog"),
        },
        {
          label: this.getNLS("toolbar.menu.export"),
          callback: lang.hitch(this, "showDownloadDialog"),
        },
        { css: "MatcToolbarPopUpLine" },
        {
          label: this.getNLS("toolbar.menu.change-screen-size"),
          callback: lang.hitch(this, "onChangeScreenSize"),
        },
        {
          label: this.getNLS("toolbar.menu.save-as"),
          callback: lang.hitch(this, "onSaveAs"),
        },
        { css: "MatcToolbarPopUpLine" },
        {
          label: this.getNLS("toolbar.menu.exit"),
          callback: lang.hitch(this, "onExit"),
        },
      ];
      return options;
    },
    ...
    setController(c) {
      ...
      this.own(
        this.controller.on(
          "notSavedWarningShow",
          lang.hitch(this, "showSaveButton")
        )
      );
      this.own(
        this.controller.on("commandAdded", lang.hitch(this, "onCommandAdded"))
      );
    },
    ...
    onComponentSelected(component) {
      ...
      if (this.active && component) {
        try {
          ...
          this.showDevTools();
          this.showTools();
          this.showTemplate(component);

          this.logger.log(3, "onComponentSelected", "exit");
        } catch (e) {
          console.error(e.stack);
          this.logger.sendError(e);
        }
      } else {
        this.logger.log(0, "onComponentSelected", "exit > Not Active");
      }
    },
    ...
    onNewThemeObject(obj, e) {
      this.logger.log(
        1,
        "onNewThemeObject",
        "entry > " + obj._type + " > " + obj.type + " > " + obj._isTemplate
      );
    ...
    newDesignToken(tokenType, cssProps, name) {
      ...
      if (this._selectedWidget) {
        this.controller.addDesignToken(
    ...
    linkDesignToken(designToken, cssProps) {
      ...
      var state = this._getViewStyleModelKey();
      if (this._selectedWidget) {
        this.controller.linkDesignToken(
          this._selectedWidget.id,
          designToken.id,
          state,
          cssProps,
    ...
    unlinkDesignToken(designToken) {
      ...
      var state = this._getViewStyleModelKey();
      if (this._selectedWidget) {
        this.controller.unlinkDesignToken(
          this._selectedWidget.id,
          designToken.id,
          state,
          "widget"
    ...
    changeDesignToken(designToken) {
      ...
      this.controller.updateDesignToken(
        designToken.id,
        designToken.name,
        designToken.value
      );
    ...
    onToolRemoveTemplate(e) {
      this.logger.log(
        1,
        "onToolRemoveTemplate",
        "entry : " + this._selectedWidget
      );
      this.stopEvent(e);
      if (this._selectedWidget) {
    ...
    onToolAlignElements(value, e) {
      this.logger.log(
        -1,
        "onAlignElements",
        "entry : " + this._selection + " > " + e.ctrlKey
      );
      this.stopEvent(e);
    ...
    onToolDistributeElements(value, e) {
      this.logger.log(
        -1,
        "onToolDistributeElements",
        "entry : " + this._selection
      );
      this.stopEvent(e);
    ...
    toggleLineHide(value) {
      ...
      if (this._selectedWidget) {
        ...
        if (line) {
          ...
          console.warn(
            "toggleLineHide() > No line for widget. Check should no be visible!"
          );
        }
      }
      ...
      if (this._selectedGroup) {
        ...
        if (line) {
          ...
          console.warn(
            "toggleLineHide() > No line for Group. Check should no be visible!"
          );
        }
      }
    },
    ...
    setLineProperty(key, value) {
      ...
      if (this._selectedWidget) {
        ...
        if (line) {
          ...
          console.warn(
            "setLineProperty() > No line for widget. Check should no be visible!"
          );
        }
      }
      ...
      if (this._selectedGroup) {
        ...
        if (line) {
          ...
          console.warn(
            "setLineProperty() > No line for Group. Check should no be visible!"
          );
        }
      }
    },
    ...
    setLinePropertyByID(id, key, value) {
      ...
      if (line) {
        ...
        console.warn(
          "setLinePropertyByID() > No line with id " +
            id +
            ". Check should no be visible!"
        );
      }
    },
    ...
    updateLineByID(id, newLine) {
      ...
      if (line) {
        ...
        console.warn(
          "updateLineByID() > No line with id " +
            id +
            ". Check should no be visible!"
        );
      }
    ...
    setWidgetSize(pos) {
      ...
      if (this._selectedWidget) {
        this.controller.updateWidgetPosition(
          this._selectedWidget.id,
          pos,
          true
        );
    ...
    enableInheritedWidget() {
      ...
      if (this._selectedWidget) {
        const newWidget = this.controller.enableInheritedWidget(
          this._selectedWidget
        );
        if (newWidget) {
          /**
    ...
    setScreenSize(pos) {
      ...
      if (this._selectedScreen) {
        this.controller.updateScreenWidthAndHeight(
          this._selectedScreen.id,
          pos
        );
      }
    ...
    toggleStyle(key, value) {
      ...
      if (this._selectedWidget && this._selectedWidget.style) {
        ...
        if (widget) {
          ...
          this.controller.updateMultiProperties(
            this._selectedMulti,
            newStyle,
            modelKey
          );
    ...
    setScreenStyle(key, value) {
      ...
      if (this._selectedScreen) {
        if (this._selectedScreen.style) {
          var newSytle = {};
          newSytle[key] = value;
          this.controller.updateScreenProperties(
            this._selectedScreen.id,
            newSytle,
            "style"
          );
    ...
    setRulerProperties(props) {
      ...
      if (this._selectedRuler) {
        this.controller.updateScreenRulerProps(
          this._selectedRuler.screen.id,
          this._selectedRuler.ruler.id,
          props
        );
      }
      return false;
    ...
    setRulerPosition(v) {
      ...
      if (this._selectedRuler) {
        this.controller.updateScreenRulerValue(
          this._selectedRuler.screen.id,
          this._selectedRuler.ruler.id,
          v
        );
    ...
    setScreenStart(key, value) {
      ...
      if (this._selectedScreen) {
        if (this._selectedScreen.props) {
          var newProps = {};
          newProps[key] = value;
          this.controller.updateScreenStart(
            this._selectedScreen.id,
            newProps,
            "props"
          );
